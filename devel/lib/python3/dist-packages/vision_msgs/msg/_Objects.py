...
"""autogenerated by genpy from vision_msgs/Objects.msg. Do not edit."""
import codecs
import sys
...
class Objects(genpy.Message):
  _md5sum = "19f71dba810720091bb37489652c025c"
  _type = "vision_msgs/Objects"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """vision_msgs/Ball ball
...
string frame_id
"""
  __slots__ = ['ball','goal','robots','image']
  _slot_types = ['vision_msgs/Ball','vision_msgs/Goal','vision_msgs/Robot[]','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = vision_msgs.msg.Goal()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B4iB2i().pack(_x.ball.found, _x.ball.x, _x.ball.y, _x.ball.roi_width, _x.ball.roi_height, _x.goal.found, _x.goal.x, _x.goal.y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ball.found, _x.ball.x, _x.ball.y, _x.ball.roi_width, _x.ball.roi_height, _x.goal.found, _x.goal.x, _x.goal.y,) = _get_struct_B4iB2i().unpack(str[start:end])
      self.ball.found = bool(self.ball.found)
      self.goal.found = bool(self.goal.found)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.robots = []
      for i in range(0, length):
        val1 = vision_msgs.msg.Robot()
        _x = val1
        start = end
        end += 8
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_B4iB2i = None
def _get_struct_B4iB2i():
    global _struct_B4iB2i
    if _struct_B4iB2i is None:
        _struct_B4iB2i = struct.Struct("<B4iB2i")
    return _struct_B4iB2i
_struct_BI = None
def _get_struct_BI():
    global _struct_BI
