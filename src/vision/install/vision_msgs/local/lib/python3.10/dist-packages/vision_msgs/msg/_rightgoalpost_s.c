...
bool vision_msgs__msg__rightgoalpost__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._rightgoalpost.Rightgoalpost", full_classname_dest, 44) == 0);
  }
  vision_msgs__msg__Rightgoalpost * ros_message = _ros_message;
  {  // found
...
{
  /* NOTE(esteve): Call constructor of Rightgoalpost */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._rightgoalpost");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Rightgoalpost");
