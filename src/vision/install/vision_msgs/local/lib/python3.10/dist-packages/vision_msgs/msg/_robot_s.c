...
bool vision_msgs__msg__robot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._robot.Robot", full_classname_dest, 28) == 0);
  }
  vision_msgs__msg__Robot * ros_message = _ros_message;
  {  // x
...
PyObject * vision_msgs__msg__robot__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._robot");
