...
bool vision_msgs__msg__robot__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool vision_msgs__msg__objects__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._objects.Objects", full_classname_dest, 32) == 0);
  }
  vision_msgs__msg__Objects * ros_message = _ros_message;
  {  // ball
  ...
  {  // goal
    ...
    if (!vision_msgs__msg__goal__convert_from_py(field, &ros_message->goal)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // robots
    ...
    if (!vision_msgs__msg__Robot__Sequence__init(&(ros_message->robots), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create vision_msgs__msg__Robot__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    vision_msgs__msg__Robot * dest = ros_message->robots.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!vision_msgs__msg__robot__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * vision_msgs__msg__objects__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._objects");
  ...
  {  // goal
    PyObject * field = NULL;
    field = vision_msgs__msg__goal__convert_to_py(&ros_message->goal);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // robots
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = vision_msgs__msg__robot__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
