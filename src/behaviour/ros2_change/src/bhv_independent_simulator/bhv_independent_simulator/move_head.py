...
class HeadMover():
    ...
    def init_head(self):
        ...
        #rospy.Service('/bhv2mov_communicator/head_requisitions', moveRequest, self.moveSimHead) (5)
        self.node.create_service(MoveRequest, '/bhv2mov_communicator/head_requisitions', self.moveSimHead) #(5)
        #self.response = moveRequestResponse() (6) Não será mas necessário, se tornou argumento da função moveSimHead
        
    #Função responsável pela captura dos request
    def moveSimHead(self, request,  response):
        """
        -> Funcao:
