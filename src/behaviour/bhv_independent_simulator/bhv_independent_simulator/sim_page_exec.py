...
#from modularized_bhv_msgs.srv import moveRequest, moveRequestResponse (2) #Srv associado ao service utilizado para requisitar qualquer movimento dos motores
from modularized_bhv_msgs.srv import MoveRequest, MoveRequestResponse #(2) #Srv associado ao service utilizado para requisitar qualquer movimento dos motores
...
class RobotPagesExec():
    ...
    def __init__(self, supervisor):
        ...
        #rospy.Service('/bhv2mov_communicator/page_requisitions', moveRequest, self.pageSimRobot) (3)
        self.node.create_service(MoveRequest, '/bhv2mov_communicator/page_requisitions', self.pageSimRobot) #(3)
        #self.response = moveRequestResponse() (4) Não será mas necessário, está incluido no argumento da função pageSimRobot
    ...
    def pageSimRobot(self, request, response): #(4)
        """
        -> Funcao:
