...
class BhvIndependentSim(object):
    ...
    def start(self):
        #while self.general_supervisor.step(32) != -1 and not rospy.is_shutdown(): (2)
        while self.general_supervisor.step(32) != -1 and not rclpy.ok(): #(2)
...
if __name__ == '__main__':
    #rospy.init_node('Bhv_independent_simulator_node', anonymous=False) (3)
    rclpy.init(args=sys.argv) #(3)
    node = rclpy.create_node('Bhv_independent_simulator_node') #(3)
