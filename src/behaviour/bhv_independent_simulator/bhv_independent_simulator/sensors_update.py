...
class RobotSensors():
    ...
    def init_head(self):
        ...
        self.head_pos_publisher = self.create_publisher('/webots/motors', simMovMsg, queue_size=10)
    ...
    def init_accel(self):
        ...
        self.accel_publisher = self.create_publisher('/webots_natasha/behaviour_controller', Vector3, queue_size=100)
    ...
    def init_cam(self):
        ...
        self.pubImage = self.create_publisher('/webots_natasha/vision_controller', visionSimImage, queue_size= 33)
