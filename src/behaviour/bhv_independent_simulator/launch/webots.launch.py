...
from launch.substitutions import PythonExpression, LaunchConfiguration # Já importados
...
def generate_launch_description():
    ...
    no_gui_arg = DeclareLaunchArgument(
        'no_gui',
        default_value='False', # É uma string "False"
    ...
    webots_node = ExecuteProcess(
        cmd=[
            ...
            'gui:=', PythonExpression([
                "'True' if '", LaunchConfiguration('no_gui'), "' == 'False' else 'False'"
            ])
        ],
        name='webots',
        output='screen'
