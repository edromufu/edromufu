...
if rospy.get_param('u2d2/robot_name') == 'aurea':
    ...
    MIN_MAX_DICT = {0: [570,4095],1: [0,3500],2: [2040,3600],3: [500,2100],4: [700,2300],
                    5: [1800,3400],6: [1930,2425],7: [1589,2275],8: [1600,2444],9: [1500,2500],
                    10: [1690,3400],11: [650,2922],12: [750,3000],13: [750,3000],14: [900,2300],
                    15: [865,2330],16: [1760,2290],17: [1665,2500],18: [0,1023],19: [0,1023]}
else:
    print('Natasha')
