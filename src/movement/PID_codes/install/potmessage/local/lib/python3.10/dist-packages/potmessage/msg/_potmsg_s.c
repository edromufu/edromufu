...
bool potmessage__msg__potmsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // pot1
    ...
    ros_message->pot1 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pot2
    ...
    assert(PyFloat_Check(field));
    ros_message->pot2 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pot3
    ...
    assert(PyFloat_Check(field));
    ros_message->pot3 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pot4
    ...
    assert(PyFloat_Check(field));
    ros_message->pot4 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pot5
    ...
    assert(PyFloat_Check(field));
    ros_message->pot5 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pot6
    ...
    assert(PyFloat_Check(field));
    ros_message->pot6 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pot7
    ...
    assert(PyFloat_Check(field));
    ros_message->pot7 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pot8
    ...
    assert(PyFloat_Check(field));
    ros_message->pot8 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * potmessage__msg__potmsg__convert_to_py(void * raw_ros_message)
{
  ...
  {  // pot1
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pot1);
    {
  ...
  {  // pot2
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pot2);
    {
  ...
  {  // pot3
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pot3);
    {
  ...
  {  // pot4
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pot4);
    {
  ...
  {  // pot5
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pot5);
    {
  ...
  {  // pot6
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pot6);
    {
  ...
  {  // pot7
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pot7);
    {
  ...
  {  // pot8
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->pot8);
    {
