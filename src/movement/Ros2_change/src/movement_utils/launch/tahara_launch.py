...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('robot_name', default_value='tahara'),
        DeclareLaunchArgument('page_creation', default_value='false'),
        DeclareLaunchArgument('erro', default_value='true'),
        ...
        # Node: page_creator
        Node(
            package='tahara_pages',
            executable='software_pages',
            name='page_creator',
            output='log',
        ...
        Node(
            ...
            executable='erro_publisher',
            name='erro_publisher',
            output='screen',
            condition=IfCondition(LaunchConfiguration('erro')),
        ),
        # Node: page_creator
        #Node(
