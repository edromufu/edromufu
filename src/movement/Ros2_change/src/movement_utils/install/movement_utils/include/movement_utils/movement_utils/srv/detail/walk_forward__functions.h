...
#ifndef MOVEMENT_UTILS__SRV__DETAIL__WALK_FORWARD__FUNCTIONS_H_
#define MOVEMENT_UTILS__SRV__DETAIL__WALK_FORWARD__FUNCTIONS_H_
...
/// Initialize srv/WalkForward message.
/**
...
/// Finalize srv/WalkForward message.
/**
...
/// Create srv/WalkForward message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * movement_utils__srv__WalkForward_Request__init().
...
/// Destroy srv/WalkForward message.
/**
 * It calls
 * movement_utils__srv__WalkForward_Request__fini()
...
/// Check for srv/WalkForward message equality.
/**
...
/// Copy a srv/WalkForward message.
/**
...
/// Initialize array of srv/WalkForward messages.
/**
...
/// Finalize array of srv/WalkForward messages.
/**
 * It calls
 * movement_utils__srv__WalkForward_Request__fini()
...
/// Create array of srv/WalkForward messages.
/**
 * It allocates the memory for the array and calls
 * movement_utils__srv__WalkForward_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/WalkForward messages.
/**
 * It calls
 * movement_utils__srv__WalkForward_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/WalkForward message array equality.
/**
...
/// Copy an array of srv/WalkForward messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * movement_utils__srv__WalkForward_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_movement_utils
...
/**
 * It calls
 * movement_utils__srv__WalkForward_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_movement_utils
...
/**
 * It allocates the memory for the array and calls
 * movement_utils__srv__WalkForward_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_movement_utils
...
/**
 * It calls
 * movement_utils__srv__WalkForward_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOVEMENT_UTILS__SRV__DETAIL__WALK_FORWARD__FUNCTIONS_H_
