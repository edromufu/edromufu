  ...
  std::ostream & out)
{
  ...
  {
    out << "imu1: ";
    rosidl_generator_traits::value_to_yaml(msg.imu1, out);
    out << ", ";
  }
  ...
  {
    out << "imu2: ";
    rosidl_generator_traits::value_to_yaml(msg.imu2, out);
    out << ", ";
  }
  ...
  {
    out << "imu3: ";
    rosidl_generator_traits::value_to_yaml(msg.imu3, out);
  }
  out << "}";
