...
class Metaclass_HeadMotorsData(type):
    """Metaclass of message 'HeadMotorsData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'movement_utils.msg.HeadMotorsData')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__head_motors_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__head_motors_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__head_motors_data
            cls._TYPE_SUPPORT = module.type_support_msg__msg__head_motors_data
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__head_motors_data
...
class HeadMotorsData(metaclass=Metaclass_HeadMotorsData):
    """Message class 'HeadMotorsData'."""
