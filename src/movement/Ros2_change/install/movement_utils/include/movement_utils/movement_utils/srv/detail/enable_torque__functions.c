...
movement_utils__srv__EnableTorque_Request__init(movement_utils__srv__EnableTorque_Request * msg)
{
  ...
  // data
  // motor_ids
  if (!rosidl_runtime_c__int8__Sequence__init(&msg->motor_ids, 0)) {
    movement_utils__srv__EnableTorque_Request__fini(msg);
    return false;
  }
  return true;
}
...
movement_utils__srv__EnableTorque_Request__fini(movement_utils__srv__EnableTorque_Request * msg)
{
  ...
  // data
  // motor_ids
  rosidl_runtime_c__int8__Sequence__fini(&msg->motor_ids);
}
...
movement_utils__srv__EnableTorque_Request__create()
{
  ...
  movement_utils__srv__EnableTorque_Request * msg = (movement_utils__srv__EnableTorque_Request *)allocator.allocate(sizeof(movement_utils__srv__EnableTorque_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(movement_utils__srv__EnableTorque_Request));
  bool success = movement_utils__srv__EnableTorque_Request__init(msg);
  if (!success) {
...
movement_utils__srv__EnableTorque_Request__Sequence__init(movement_utils__srv__EnableTorque_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  movement_utils__srv__EnableTorque_Request * data = NULL;

  if (size) {
    data = (movement_utils__srv__EnableTorque_Request *)allocator.zero_allocate(size, sizeof(movement_utils__srv__EnableTorque_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = movement_utils__srv__EnableTorque_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        movement_utils__srv__EnableTorque_Request__fini(&data[i - 1]);
      }
...
movement_utils__srv__EnableTorque_Request__Sequence__fini(movement_utils__srv__EnableTorque_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      movement_utils__srv__EnableTorque_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  movement_utils__srv__EnableTorque_Request__Sequence * array = (movement_utils__srv__EnableTorque_Request__Sequence *)allocator.allocate(sizeof(movement_utils__srv__EnableTorque_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = movement_utils__srv__EnableTorque_Request__Sequence__init(array, size);
  if (!success) {
...
movement_utils__srv__EnableTorque_Request__Sequence__destroy(movement_utils__srv__EnableTorque_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    movement_utils__srv__EnableTorque_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
movement_utils__srv__EnableTorque_Request__Sequence__are_equal(const movement_utils__srv__EnableTorque_Request__Sequence * lhs, const movement_utils__srv__EnableTorque_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!movement_utils__srv__EnableTorque_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  movement_utils__srv__EnableTorque_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(movement_utils__srv__EnableTorque_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    movement_utils__srv__EnableTorque_Request * data =
      (movement_utils__srv__EnableTorque_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!movement_utils__srv__EnableTorque_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          movement_utils__srv__EnableTorque_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!movement_utils__srv__EnableTorque_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  movement_utils__srv__EnableTorque_Response * msg = (movement_utils__srv__EnableTorque_Response *)allocator.allocate(sizeof(movement_utils__srv__EnableTorque_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(movement_utils__srv__EnableTorque_Response));
  bool success = movement_utils__srv__EnableTorque_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
movement_utils__srv__EnableTorque_Response__destroy(movement_utils__srv__EnableTorque_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    movement_utils__srv__EnableTorque_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
movement_utils__srv__EnableTorque_Response__Sequence__init(movement_utils__srv__EnableTorque_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  movement_utils__srv__EnableTorque_Response * data = NULL;

  if (size) {
    data = (movement_utils__srv__EnableTorque_Response *)allocator.zero_allocate(size, sizeof(movement_utils__srv__EnableTorque_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = movement_utils__srv__EnableTorque_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        movement_utils__srv__EnableTorque_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
movement_utils__srv__EnableTorque_Response__Sequence__fini(movement_utils__srv__EnableTorque_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      movement_utils__srv__EnableTorque_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  movement_utils__srv__EnableTorque_Response__Sequence * array = (movement_utils__srv__EnableTorque_Response__Sequence *)allocator.allocate(sizeof(movement_utils__srv__EnableTorque_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = movement_utils__srv__EnableTorque_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
movement_utils__srv__EnableTorque_Response__Sequence__destroy(movement_utils__srv__EnableTorque_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    movement_utils__srv__EnableTorque_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
movement_utils__srv__EnableTorque_Response__Sequence__are_equal(const movement_utils__srv__EnableTorque_Response__Sequence * lhs, const movement_utils__srv__EnableTorque_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!movement_utils__srv__EnableTorque_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  movement_utils__srv__EnableTorque_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(movement_utils__srv__EnableTorque_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    movement_utils__srv__EnableTorque_Response * data =
      (movement_utils__srv__EnableTorque_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!movement_utils__srv__EnableTorque_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          movement_utils__srv__EnableTorque_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!movement_utils__srv__EnableTorque_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
