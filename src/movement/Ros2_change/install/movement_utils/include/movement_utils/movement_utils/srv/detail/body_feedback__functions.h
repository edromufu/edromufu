...
#ifndef MOVEMENT_UTILS__SRV__DETAIL__BODY_FEEDBACK__FUNCTIONS_H_
#define MOVEMENT_UTILS__SRV__DETAIL__BODY_FEEDBACK__FUNCTIONS_H_
...
/// Initialize srv/BodyFeedback message.
/**
...
/// Finalize srv/BodyFeedback message.
/**
...
/// Create srv/BodyFeedback message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * movement_utils__srv__BodyFeedback_Request__init().
...
/// Destroy srv/BodyFeedback message.
/**
 * It calls
 * movement_utils__srv__BodyFeedback_Request__fini()
...
/// Check for srv/BodyFeedback message equality.
/**
...
/// Copy a srv/BodyFeedback message.
/**
...
/// Initialize array of srv/BodyFeedback messages.
/**
...
/// Finalize array of srv/BodyFeedback messages.
/**
 * It calls
 * movement_utils__srv__BodyFeedback_Request__fini()
...
/// Create array of srv/BodyFeedback messages.
/**
 * It allocates the memory for the array and calls
 * movement_utils__srv__BodyFeedback_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/BodyFeedback messages.
/**
 * It calls
 * movement_utils__srv__BodyFeedback_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/BodyFeedback message array equality.
/**
...
/// Copy an array of srv/BodyFeedback messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * movement_utils__srv__BodyFeedback_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_movement_utils
...
/**
 * It calls
 * movement_utils__srv__BodyFeedback_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_movement_utils
...
/**
 * It allocates the memory for the array and calls
 * movement_utils__srv__BodyFeedback_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_movement_utils
...
/**
 * It calls
 * movement_utils__srv__BodyFeedback_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOVEMENT_UTILS__SRV__DETAIL__BODY_FEEDBACK__FUNCTIONS_H_
