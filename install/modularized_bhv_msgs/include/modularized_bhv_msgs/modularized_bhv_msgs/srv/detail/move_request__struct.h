...
enum
{
  modularized_bhv_msgs__srv__MoveRequest_Event__request__MAX_SIZE = 1
};
// response
enum
{
  modularized_bhv_msgs__srv__MoveRequest_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/MoveRequest in the package modularized_bhv_msgs.
typedef struct modularized_bhv_msgs__srv__MoveRequest_Event
{
  service_msgs__msg__ServiceEventInfo info;
  modularized_bhv_msgs__srv__MoveRequest_Request__Sequence request;
  modularized_bhv_msgs__srv__MoveRequest_Response__Sequence response;
} modularized_bhv_msgs__srv__MoveRequest_Event;

// Struct for a sequence of modularized_bhv_msgs__srv__MoveRequest_Event.
typedef struct modularized_bhv_msgs__srv__MoveRequest_Event__Sequence
{
