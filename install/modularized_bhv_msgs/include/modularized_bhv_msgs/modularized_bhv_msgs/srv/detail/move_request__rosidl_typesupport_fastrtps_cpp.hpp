...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_modularized_bhv_msgs
cdr_serialize(
  const modularized_bhv_msgs::srv::MoveRequest_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  modularized_bhv_msgs::srv::MoveRequest_Event & ros_message);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_modularized_bhv_msgs
max_serialized_size_MoveRequest_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_modularized_bhv_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, modularized_bhv_msgs, srv, MoveRequest_Event)();
