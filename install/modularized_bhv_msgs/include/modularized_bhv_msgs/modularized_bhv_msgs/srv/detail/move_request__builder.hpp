...
class Init_MoveRequest_Event_response
{
public:
  explicit Init_MoveRequest_Event_response(::modularized_bhv_msgs::srv::MoveRequest_Event & msg)
  : msg_(msg)
  {}
  ::modularized_bhv_msgs::srv::MoveRequest_Event response(::modularized_bhv_msgs::srv::MoveRequest_Event::_response_type arg)
  {
...
private:
  ::modularized_bhv_msgs::srv::MoveRequest_Event msg_;
};

class Init_MoveRequest_Event_request
{
public:
  explicit Init_MoveRequest_Event_request(::modularized_bhv_msgs::srv::MoveRequest_Event & msg)
  : msg_(msg)
  {}
  Init_MoveRequest_Event_response request(::modularized_bhv_msgs::srv::MoveRequest_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_MoveRequest_Event_response(msg_);
  }
...
class Init_MoveRequest_Event_info
{
public:
  Init_MoveRequest_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MoveRequest_Event_request info(::modularized_bhv_msgs::srv::MoveRequest_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_MoveRequest_Event_request(msg_);
  }
...
template<>
inline
auto build<::modularized_bhv_msgs::srv::MoveRequest_Event>()
{
  return modularized_bhv_msgs::srv::builder::Init_MoveRequest_Event_info();
}
